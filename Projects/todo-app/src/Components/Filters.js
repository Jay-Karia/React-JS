...
export default function Filters(props) {
  ...
  return (
    ...
    <div className="container filters">
        <div className="button button-1 mx-5" onClick={()=>{props.filter_("all")}}>All Tasks</div>
        <div className="button button-2 mx-5" onClick={()=>{props.filter_("done")}}>Completed Tasks</div>
        <div className="button button-3 mx-5" onClick={()=>{props.filter_("remaining")}}>Remaining Tasks</div>
        <div className="button button-9 mx-5" onClick={()=>{props.filter_("starred")}}>Starred Tasks</div>
    </div>
    <hr />
